...
int main(int argc, char** argv) {
    ...
    int nOperaciones =0 , nPendientes= 0;  
   ...
   // COMPLETAR inicialización variables locales
    vectorOperaciones = reservarVOperat(nOperaciones);
    vectorPendientes = reservarVOperat(nPendientes);
   ...
   // COMPLETAR leer todas las operaciones
    ...
    while(getline(archivo,linea)){
        Operacion una;
        una.set(linea);
        agnadeOperacionVOperat(vectorOperaciones,nOperaciones,una);
    ...
    liquidez = calculaImporteVOperat(vectorOperaciones, nOperaciones);
    cout << liquidez << endl;
